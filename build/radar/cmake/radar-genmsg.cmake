...
set(MSG_I_FLAGS "-Iradar:/home/jiwoo/kld7/src/radar/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jiwoo/kld7/src/radar/msg/radar_message.msg" NAME_WE)
add_custom_target(_radar_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "radar" "/home/jiwoo/kld7/src/radar/msg/radar_message.msg" ""
)
...
_generate_msg_cpp(radar
  "/home/jiwoo/kld7/src/radar/msg/radar_message.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/radar)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/radar\")")
  # install generated code
  install(
